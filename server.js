...
// Simple in-memory key-value store backing all shared game state.
const store = new Map();
...
// Rooms/moves are small and short-lived; sweep anything untouched for a
...
app.listen(PORT, () => {
  console.log(`Beastforge server running on http://localhost:${PORT}`);
});
